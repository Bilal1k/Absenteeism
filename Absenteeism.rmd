...
The dataset was acquired from UCI Machine Learning Repository. For more information click ([here](https://archive.ics.uci.edu/ml/datasets/Absenteeism+at+work)).
...
str(data)
```
The dataset has 21 variables and 751 observations. 
...
3. Exploratory Data Analysis by Tukey, John W. ([here](https://archive.org/details/exploratorydataa00tuke_0))

4. Feature Normalization and Likelihood-based Similarity Measures for Image Retrieval by Selim Aksoy and Robert M. Haralick.
([here](http://www.cs.bilkent.edu.tr/~saksoy/papers/prletters01_likelihood.pdf))
